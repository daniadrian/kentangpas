...
const getAllSeedParameters = async () => {
  try {
    const query = 'SELECT id, generation_name, seeds_per_kg_min, seeds_per_kg_max, price_per_unit_min, price_per_unit_max, price_unit FROM seed_parameters ORDER BY id ASC';
